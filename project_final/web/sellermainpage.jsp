...
<%
    ...
    System.out.println("Page sellermainpage.jsp");
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.update').on('click', function(event){
            ...
            window.location.href=("updateModel.jsp");
        });
