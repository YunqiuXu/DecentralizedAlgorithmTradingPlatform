...
<%
    ...
    System.out.println("Page freelancerMainpage.jsp");
...
<head>
    ...
    <title>Freelancer mainpage</title>
        ...
        <nav class="navbar navbar-inverse" role="navigation">
            ...
            <div id="main-nav" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a style="font-size: 16px;" class="accepted_requests" href="#">Already accepted</a></li>
...
<div class="parallax-content baner-content" id="home">
    <div class="container">
        <div class="text-content" style="margin-top: -20px;">
            <h2 style="margin-bottom:40px">free<span>la</span>ncer Pag<em>e</em></h2>
                <form id="_form" method="post" action="accepting.jsp">
                    <input type="text" style="width: 400px; margin-right: 20px" name="search" placeholder="If no keyword, show all models" />
                    <a href="#" style="border-radius:20px"onclick="document.getElementById('_form').submit();" type="button" class="animBtn themeB">Search</a>
                </form>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.accepted_requests').on('click', function(event){
