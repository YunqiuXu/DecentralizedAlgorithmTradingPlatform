...
<%
    ...
    System.out.println("Page start.jsp");
    ...
    <div class="container">
        <div class="text-content">
            <div class="container-button">
                <h2><em>Please</em> choose <span>your</span> role</h2>
                <div class="toggle-button">
                    <div class="cubeshape cube">
                        <div class="first_cube">
                            <h1><a href="#">I am a buyer</a></h1>
                        </div>
                        <div class="second_cube">
                            <h1><a href="#" class="buyer">Go</a></h1>
                        </div>
                    </div>
                </div>
                </br>
                <div class="toggle-button-2">
                    <div class="cubeshape cube2">
                        <div class="first_cube2">
                            <h1><a href="#">I am a seller</a></h1>
                        </div>
                        <div class="second_cube2">
                            <h1><a href="#" class="seller">Go</a></h1>
                        </div>
                    </div>
                </div>
                </br>
                <div class="toggle-button">
                    <div class="cubeshape cube">
                        <div class="first_cube">
                            <h1><a href="#">I am a client</a></h1>
                        </div>
                        <div class="second_cube">
                            <h1><a href="#" class="client">Go</a></h1>
                        </div>
                    </div>
                </div>
                </br>
                <div class="toggle-button-2">
                    <div class="cubeshape cube2">
                        <div class="first_cube2">
                            <h1><a href="#">I am a freelancer</a></h1>
                        </div>
                        <div class="second_cube2">
                            <h1><a href="#" class="freelancer">Go</a></h1>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.buyer').on('click', function(event){
            ...
            window.location.href=("buyermainpage.jsp");
        });
        $('.seller').on('click', function(event){
            event.preventDefault();
            window.location.href=("sellermainpage.jsp");
        });
        $('.client').on('click', function(event){
            event.preventDefault();
            window.location.href=("clientMainpage.jsp");
        });
        $('.freelancer').on('click', function(event){
            event.preventDefault();
            window.location.href=("freelancerMainpage.jsp");
        });
